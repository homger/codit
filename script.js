...
let test_interval_array = [new _gd_interval(2,5,"Z"),new _gd_interval(0,3,"A"), new _gd_interval(0,6,"B"), new _gd_interval(3,6,"C")];
...
function main(){
    ...
    VisualiseNestedInterval(_gd_interval.nested_interval_range_from_interval_list());
    //debugger;
    /*editor.newLine()
    editor.newLine()
